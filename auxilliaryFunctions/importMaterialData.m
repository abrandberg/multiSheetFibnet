function materialData = importMaterialData(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   MATERIALDATA = IMPORTFILE(FILENAME) Reads data from text file FILENAME
%   for the default selection.
%
%   MATERIALDATA = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from
%   rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   materialData = importfile('materialData.csv', 1, 25);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2018/10/25 12:41:59
...
materialData = [dataArray{1:end-1}];
