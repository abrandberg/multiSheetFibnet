function realData = importRealData(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   REALDATA = IMPORTFILE(FILENAME) Reads data from text file FILENAME for
%   the default selection.
%
%   REALDATA = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from rows
%   STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   realData = importfile('realData.csv', 1, 4904);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2018/10/25 11:09:49
