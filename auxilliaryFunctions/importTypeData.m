function file1L30 = importTypeData(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   FILE1L30 = IMPORTFILE(FILENAME) Reads data from text file FILENAME for
%   the default selection.
%
%   FILE1L30 = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from rows
%   STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   file1L30 = importfile('file1_L30.0_W6.0_g300.0.typ', 1, 163643);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2018/09/14 16:28:40
